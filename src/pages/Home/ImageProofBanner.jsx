    ...
    <div className="w-full bg-[#3B4E42] py-16">
      ...
      <div className="px-4 md:px-16 h-[60vh] md:h-[75vh]  mx-auto">
        <Swiper
          direction={'vertical'}
          slidesPerView={1}
          spaceBetween={30} // Added a small space between slides so they don't bleed together
          mousewheel={{ releaseOnEdges: true }}
          pagination={{ 
            clickable: true,
            // Custom bullet styling via Tailwind classes in your global CSS is recommended, 
            // but this makes sure they show up!
          }}
      ...
      {/* Quick CSS fix for Swiper pagination dots to match the dark theme */}
      <style>{`
